...
@section('content')
    <div class="container">
        <div class="page-header">
            <h1>Tutorials <small>by {{ $user->username }}</small></h1>
        </div>
               ...
               @foreach($articles as $article)
                   <div class="media">
                       <div class="media-body">
                           ...
                           <br><br>
                           <a href="{{ url('@'.$article->user->username.'/article/'.$article->slug) }}" class="btn btn-sm btn-primary">Read Tutorial</a>
                       </div>
                   </div>
               @endforeach
