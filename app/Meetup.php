...
class Meetup extends Model implements Reviewable, Reportable, SluggableInterface
{
    use SoftDeletes, RecordsActivity, ReviewableTrait, ReportableTrait, SluggableTrait;
